...
namespace DNWS
{
    class PM25Plugin : IPlugin
    {
        ...
        public HTTPResponse GetResponse(HTTPRequest request)
        {
            ...
            //Use JsonSerializer to serilize(get raw json) the pm25reading mapping
            response.body = Encoding.UTF8.GetBytes(JsonSerializer.Serialize<PM25Reading>(pm25reading));
            return response;
        }
