...
namespace DNWS
{
    ...
    public class DotNetWebServer
    {
        ...
        public void Start()
        {
            string ThreadModel = Program.Configuration["Thread"];
            ...
            _parent.Log("Thread Model : " + ThreadModel + "Thread.");
            while (true)
            {
                try
                {
                    ...
                    if (ThreadModel == "Single") // Single-Thread Model
                    {
                        hp.Process();
                    }

                    else if (ThreadModel == "Multi") // Multi-Thread Model
                    {
